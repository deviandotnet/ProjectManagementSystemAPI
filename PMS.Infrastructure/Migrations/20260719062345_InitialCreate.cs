        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRecurringAnnually = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekStartDay = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    DefaultTimelineScale = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)2),
                    ProgressMode = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionItemName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    Sequence = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualRemarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedStartWeek = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    PlannedEndWeek = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    DurationCalendarDays = table.Column<int>(type: "int", nullable: false),
