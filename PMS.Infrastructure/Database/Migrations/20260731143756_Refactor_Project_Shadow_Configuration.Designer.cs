...
namespace PMS.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260731143756_Refactor_Project_Shadow_Configuration")]
    partial class Refactor_Project_Shadow_Configuration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.Domain.ActionItems.ActionItem", b =>
                {
                    b.HasOne("PMS.Domain.Categories.Category", "Category")
                        .WithMany("ActionItems")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PMS.Domain.Users.User", "Owner")
                        .WithMany("OwnedActionItems")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PMS.Domain.Projects.Project", "Project")
                        .WithMany("ActionItems")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PMS.Domain.SubCategories.SubCategory", "SubCategory")
                        .WithMany("ActionItems")
            ...
            modelBuilder.Entity("PMS.Domain.AuditLogs.AuditLog", b =>
                {
                    b.HasOne("PMS.Domain.Users.User", "ChangedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("PMS.Domain.ProjectMembers.ProjectMember", b =>
                {
                    ...
                    b.HasOne("PMS.Domain.Users.User", "User")
                        .WithMany("ProjectMembers")
