...
public class UpdateActionItemCommandValidatorTests
{
    private readonly UpdateActionItemCommandValidator _validator = new();
    ...
    public void Should_HaveError_WhenPlannedEndDateBeforePlannedStartDate()
    {
        // Arrange
        var command = new UpdateActionItemCommand(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Valid Name", null,
            Priority.Medium, null, null, null, 1, null,
    ...
    public void Should_NotHaveError_WhenCommandIsValid()
    {
        // Arrange
        var command = new UpdateActionItemCommand(
            Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), null, "Valid Name", "Description",
